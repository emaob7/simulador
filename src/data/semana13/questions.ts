...
export const questionsSemana13: Question[] = [
  ...
  },
  {
    ...
    "text": "¿Cuál es el signo más temprano y frecuente de choque en el paciente pediátrico?",
    "options": [
  ...
  },
  {
    ...
    "text": "¿Durante cuánto tiempo puede persistir el riesgo de hipertensión intracraneal después de un traumatismo craneoencefálico grave?",
    "options": [
      "6 horas.",
      "12 horas.",
      "24 horas.",
