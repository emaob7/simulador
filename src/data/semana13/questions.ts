...
export const questionsSemana13: Question[] = [
  {
    "id": "semana13_pediatria_q01",
    "text": "¿Cuál es el objetivo principal de la evaluación primaria en un niño críticamente enfermo?",
    "options": [
      "Establecer inmediatamente el diagnóstico etiológico definitivo",
      "Realizar una historia clínica completa antes de intervenir",
      "Identificar rápidamente alteraciones potencialmente mortales y tratarlas de forma prioritaria",
      "Solicitar estudios de laboratorio e imágenes antes de iniciar el tratamiento",
  ...
  {
    "id": "semana13_pediatria_q02",
    "text": "Durante la evaluación general inicial de un niño, ¿qué tres componentes deben valorarse en pocos segundos?",
    "options": [
      "Frecuencia cardiaca, presión arterial y temperatura",
      "Apariencia general, trabajo respiratorio y circulación",
      "Estado nutricional, hidratación y desarrollo psicomotor",
      "Vía aérea, glucemia y respuesta pupilar",
  ...
  {
    "id": "semana13_pediatria_q03",
    "text": "¿Cuál de los siguientes hallazgos forma parte de la valoración de la apariencia general del niño?",
    "options": [
      "Ruidos respiratorios adventicios",
      "Llenado capilar",
      "Tono, interacción y consolabilidad",
  ...
  {
    "id": "semana13_pediatria_q04",
    "text": "Si un niño no responde al llamado del profesional durante la evaluación inicial, ¿cuál es la conducta inmediata más apropiada?",
    "options": [
      "Esperar varios minutos para confirmar la falta de respuesta",
      "Solicitar primero una radiografía de tórax",
      "Iniciar únicamente la medición de la presión arterial",
  ...
  {
    "id": "semana13_pediatria_q05",
    "text": "Todos los siguientes corresponden a la evaluación de la circulación en el Triángulo de Evaluación Pediátrica, EXCEPTO:",
    "options": [
      "Cianosis.",
      "Palidez.",
      "Piel moteada (moteado).",
      "Apariencia del niño.",
      "Sangrado."
    ],
    "correctOptionIndex": 3,
  ...
  {
    "id": "semana13_pediatria_q06",
    "text": "En el algoritmo de soporte vital básico (BLS) pediátrico para un reanimador, todas las siguientes acciones se realizan inmediatamente después de verificar la seguridad de la escena, EXCEPTO:",
    "options": [
      "Comprobar la respuesta del paciente.",
      "Pedir ayuda a las personas cercanas.",
      "Activar el sistema de emergencias mediante un dispositivo móvil, si corresponde.",
      "Iniciar desfibrilación inmediata.",
  ...
  {
    "id": "semana13_pediatria_q07",
    "text": "Respecto a la ventilación de rescate en el niño con pulso presente, todas las siguientes afirmaciones son correctas, EXCEPTO:",
    "options": [
      "Se administra 1 ventilación cada 2–3 segundos.",
      "Equivale aproximadamente a 20–30 ventilaciones por minuto.",
      "Debe reevaluarse el pulso cada 2 minutos.",
      "Si desaparece el pulso, debe iniciarse RCP.",
  ...
  {
    "id": "semana13_pediatria_q08",
    "text": "En el algoritmo de BLS pediátrico, todas las siguientes son indicaciones para iniciar RCP, EXCEPTO:",
    "options": [
      "Ausencia de pulso.",
      "Respiración agónica sin pulso.",
      "Frecuencia cardíaca menor de 60/min con signos de mala perfusión.",
      "Ausencia de respiración con pulso presente.",
  ...
  {
    "id": "semana13_pediatria_q09",
    "text": "Respecto al Soporte Vital Básico pediátrico con dos reanimadores, todas las siguientes funciones corresponden al segundo reanimador, EXCEPTO:",
    "options": [
      "Activar el sistema de respuesta a emergencias.",
      "Traer el desfibrilador externo automático (DEA) y el equipo de emergencia.",
      "Permanecer con el niño durante toda la evaluación inicial.",
      "Regresar para colaborar en la reanimación una vez obtenido el DEA.",
  ...
  {
    "id": "semana13_pediatria_q10",
    "text": "Respecto a la relación entre compresiones y ventilaciones en la reanimación cardiopulmonar pediátrica con dos reanimadores, todas las siguientes afirmaciones son correctas, EXCEPTO:",
    "options": [
      "Inicialmente, si solo hay un reanimador, se realizan 30 compresiones por 2 ventilaciones.",
      "Cuando se incorpora el segundo reanimador, la relación cambia a 15 compresiones por 2 ventilaciones.",
      "La relación de 15 compresiones por 2 ventilaciones se utiliza desde el inicio, aunque solo haya un reanimador.",
      "El desfibrilador externo automático debe utilizarse tan pronto esté disponible.",
  ...
  {
    "id": "semana13_pediatria_q11",
    "text": "Respecto al uso del desfibrilador externo automático durante la reanimación cardiopulmonar pediátrica, todas las siguientes afirmaciones son correctas, EXCEPTO:",
    "options": [
      "Debe utilizarse tan pronto como esté disponible.",
      "Si identifica un ritmo desfibrilable, debe administrarse una descarga.",
      "Después de la descarga, debe reanudarse inmediatamente la RCP durante aproximadamente 2 minutos.",
      "Después de una descarga exitosa, debe esperarse 2 minutos antes de reiniciar las compresiones torácicas.",
  ...
  {
    "id": "semana13_pediatria_q12",
    "text": "Respecto al algoritmo de Soporte Vital Básico pediátrico con dos reanimadores, ¿en cuál de los siguientes escenarios está indicado iniciar inmediatamente la reanimación cardiopulmonar (RCP)?",
    "options": [
      "Niño con respiración normal y pulso palpable.",
      "Niño con apnea, pulso palpable y frecuencia cardíaca de 90 latidos por minuto.",
      "Niño con apnea, frecuencia cardíaca de 50 latidos por minuto y signos de mala perfusión.",
      "Niño con apnea, pulso palpable y frecuencia cardíaca de 80 latidos por minuto, sin signos de mala perfusión.",
  ...
  {
    "id": "semana13_pediatria_q13",
    "text": "En un niño con apnea y pulso palpable, ¿cuál de las siguientes situaciones indica iniciar reanimación cardiopulmonar (RCP)?",
    "options": [
      "Frecuencia cardíaca de 70 latidos por minuto, sin signos de mala perfusión.",
      "Frecuencia cardíaca menor de 60 latidos por minuto con signos de mala perfusión.",
      "Frecuencia cardíaca de 80 latidos por minuto con respiración agónica.",
      "Frecuencia cardíaca de 90 latidos por minuto con apnea.",
  ...
  {
    "id": "semana13_pediatria_q14",
    "text": "¿Cuándo debe cambiarse la relación de compresiones por ventilaciones de 30:2 a 15:2?",
    "options": [
      "Al iniciar la reanimación cardiopulmonar.",
      "Después de administrar la primera descarga con el desfibrilador externo automático.",
      "Al incorporarse el segundo reanimador.",
      "Después de 2 minutos de reanimación cardiopulmonar.",
  ...
  {
    "id": "semana13_pediatria_q15",
    "text": "Signos vitales según la edad ¿Cuál es la frecuencia respiratoria normal en un adolescente?",
    "options": [
      "18–25 respiraciones/min",
      "20–29 respiraciones/min",
      "22–37 respiraciones/min",
  ...
  {
    "id": "semana13_pediatria_q16",
    "text": "Signos vitales según la edad ¿Qué grupo etario presenta la frecuencia cardíaca normal más alta?",
    "options": [
      "Prematuro.",
      "Lactante.",
      "Niño pequeño.",
  ...
  {
    "id": "semana13_pediatria_q17",
    "text": "Evaluación neurológica (AVPU) En la escala AVPU, la letra \"V\" indica que el niño:",
    "options": [
      "Responde únicamente al dolor.",
      "Responde a la voz.",
  ...
  {
    "id": "semana13_pediatria_q18",
    "text": "Evaluación neurológica (AVDA) Todas las siguientes corresponden a la escala AVDA, EXCEPTO:",
    "options": [
      "Alerta.",
      "Responde a la voz.",
      "Obedece órdenes.",
  ...
  {
    "id": "semana13_pediatria_q19",
    "text": "Escala de Glasgow pediátrica modificada En un niño mayor de 2 años, ¿qué respuesta verbal obtiene el puntaje máximo en la Escala de Glasgow pediátrica modificada?",
    "options": [
      "Emite sonidos.",
  ...
  {
    "id": "semana13_pediatria_q20",
    "text": "ema: Evaluación de la circulación en las emergencias cardiorrespiratorias pediátricas ¿Cuál es el signo más temprano y frecuente de choque en el paciente pediátrico?",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q21",
    "text": "Todas las siguientes son manifestaciones de disminución de la perfusión tisular, EXCEPTO:",
    "options": [
      "Palidez.",
      "Llenado capilar prolongado.",
      "Extremidades frías.",
  ...
  {
    "id": "semana13_pediatria_q22",
    "text": "¿Cuál de las siguientes causas se asocia con midriasis bilateral?",
    "options": [
      "Opiáceos.",
      "Lesión pontina.",
  ...
  {
    "id": "semana13_pediatria_q23",
    "text": "Todas las siguientes causas producen miosis bilateral, EXCEPTO:",
    "options": [
      "Opiáceos.",
      "Organofosforados.",
      "Barbitúricos.",
  ...
  {
    "id": "semana13_pediatria_q24",
    "text": "¿Qué alteración pupilar es característica de la herniación uncal?",
    "options": [
      "Midriasis bilateral reactiva.",
      "Miosis bilateral.",
      "Midriasis media bilateral.",
      "Midriasis unilateral por compresión del III par craneal.",
      "Miosis unilateral."
    ],
    "correctOptionIndex": 3,
  ...
  {
    "id": "semana13_pediatria_q25",
    "text": "¿Qué patrón pupilar es característico del coma de origen metabólico?",
    "options": [
      "Pupilas puntiformes no reactivas.",
      "Midriasis bilateral fija.",
      "Midriasis unilateral.",
      "Pupilas en posición media fijas.",
      "Pupilas normales."
    ],
    "correctOptionIndex": 4,
  ...
  {
    "id": "semana13_pediatria_q26",
    "text": "¿Qué lesión se asocia con pupilas puntiformes pero reactivas?",
    "options": [
      "Herniación uncal.",
      "Mesencéfalo.",
  ...
  {
    "id": "semana13_pediatria_q27",
    "text": "¿Cuál de los siguientes elementos NO forma parte de la historia clínica SAMPLE?",
    "options": [
      "Signos y síntomas.",
      "Alergias.",
      "Medicamentos.",
  ...
  {
    "id": "semana13_pediatria_q28",
    "text": "En el acrónimo SAMPLE, la letra \"L\" corresponde a:",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q29",
    "text": "Respecto a la evaluación secundaria del paciente pediátrico, señale la afirmación correcta:",
    "options": [
      "Se realiza antes de la evaluación primaria.",
      "Debe retrasar las medidas de reanimación.",
      "Consiste únicamente en un examen físico completo.",
      "Incluye una historia clínica dirigida y un examen físico dirigido.",
  ...
  {
    "id": "semana13_pediatria_q30",
    "text": "En un lactante (<1 año) consciente con obstrucción grave de la vía aérea por cuerpo extraño, ¿cuál es la maniobra inicial recomendada?",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q31",
    "text": "En un niño mayor de 1 año consciente con obstrucción grave de la vía aérea, ¿cuál es la maniobra de elección?",
    "options": [
      "Cinco golpes interescapulares.",
  ...
  {
    "id": "semana13_pediatria_q32",
    "text": "Todas las siguientes recomendaciones son correctas durante el manejo de una obstrucción de la vía aérea por cuerpo extraño, EXCEPTO:",
    "options": [
      "Extraer el cuerpo extraño si es visible.",
      "Permitir que el niño adopte una posición cómoda si aún puede toser.",
      "Iniciar maniobras de desobstrucción cuando la tos deja de ser eficaz.",
      "Realizar barrido digital a ciegas de forma rutinaria.",
  ...
  {
    "id": "semana13_pediatria_q33",
    "text": "¿Qué conducta debe seguirse si un niño con obstrucción de la vía aérea por cuerpo extraño pierde la conciencia?",
    "options": [
      "Continuar únicamente con compresiones abdominales.",
      "Iniciar ventilación de rescate sin revisar la boca.",
      "Iniciar reanimación cardiopulmonar e inspeccionar la vía aérea antes de cada ventilación.",
      "Realizar barrido digital a ciegas antes de iniciar la reanimación.",
  ...
  {
    "id": "semana13_pediatria_q34",
    "text": "¿Cuál de los siguientes hallazgos obliga a sospechar obstrucción de la vía aérea por cuerpo extraño en un niño previamente sano?",
    "options": [
      "Tos productiva de varios días de evolución.",
      "Inicio súbito de tos, estridor o sibilancias.",
      "Rinorrea y fiebre alta.",
      "Disfonía progresiva de varias semanas.",
  ...
  {
    "id": "semana13_pediatria_q35",
    "text": "Según la fórmula del Nelson, ¿qué dato se utiliza para calcular el diámetro interno del tubo endotraqueal sin balón en niños mayores de 2 años?",
    "options": [
      "Peso corporal.",
      "Talla.",
      "Superficie corporal.",
  ...
  {
    "id": "semana13_pediatria_q36",
    "text": "¿Cuál es el tipo de shock más frecuente en pediatría a nivel mundial?",
    "options": [
      "Shock hipovolémico.",
      "Shock distributivo.",
      "Shock cardiogénico.",
  ...
  {
    "id": "semana13_pediatria_q37",
    "text": "Respecto al shock compensado en pediatría, señale la afirmación correcta.",
    "options": [
      "Se caracteriza por hipotensión arterial y disfunción orgánica.",
      "Puede presentarse con presión arterial normal gracias a mecanismos compensadores.",
      "Siempre requiere vasopresores desde el inicio.",
      "Se manifiesta inicialmente con bradicardia.",
  ...
  {
    "id": "semana13_pediatria_q38",
    "text": "¿Cuál de los siguientes hallazgos define el shock descompensado?",
    "options": [
      "Hipotensión arterial con disfunción orgánica.",
  ...
  {
    "id": "semana13_pediatria_q39",
    "text": "¿Cuál es la causa más frecuente de shock hipovolémico en niños a nivel mundial?",
    "options": [
      "Hemorragia masiva.",
      "Diarrea grave con pérdida de líquidos.",
      "Anafilaxia.",
      "Miocarditis.",
  ...
  {
    "id": "semana13_pediatria_q40",
    "text": "¿En qué situación debe iniciarse la reanimación cardiopulmonar (RCP) en un niño con bradicardia?",
    "options": [
      "Frecuencia cardíaca <60 latidos/min pese a una adecuada oxigenación y ventilación.",
      "Frecuencia cardíaca <80 latidos/min con pulsos débiles.",
      "Frecuencia cardíaca <100 latidos/min con alteración del estado mental.",
      "Frecuencia cardíaca <60 latidos/min sin compromiso cardiorrespiratorio.",
  ...
  {
    "id": "semana13_pediatria_q41",
    "text": "¿Cuál es el fármaco de primera elección para la bradicardia sintomática que persiste después de una adecuada oxigenación y ventilación?",
    "options": [
      "Atropina.",
      "Epinefrina.",
      "Adenosina.",
  ...
  {
    "id": "semana13_pediatria_q42",
    "text": "Todas las siguientes son causas reversibles de bradicardia pediátrica, EXCEPTO:",
    "options": [
      "Hipertensión arterial.",
      "Hipotermia.",
      "Hipoxemia.",
  ...
  {
    "id": "semana13_pediatria_q43",
    "text": "¿En cuál de las siguientes situaciones está indicada la atropina?",
    "options": [
      "Bradicardia secundaria a aumento del tono vagal o bloqueo auriculoventricular primario.",
      "Bradicardia secundaria a hipoxemia.",
      "Bradicardia secundaria a hipovolemia.",
      "Bradicardia secundaria a acidosis.",
  ...
  {
    "id": "semana13_pediatria_q44",
    "text": "¿Cuál de los siguientes hallazgos indica compromiso cardiorrespiratorio en un niño con bradicardia?",
    "options": [
      "Hipotensión arterial.",
      "Frecuencia cardíaca de 90 latidos/min en un adolescente asintomático.",
      "Bradicardia durante el sueño.",
      "Bradicardia en un atleta sin síntomas.",
  ...
  {
    "id": "semana13_pediatria_q45",
    "text": "¿Cuál de las siguientes características orienta a una taquicardia sinusal?",
    "options": [
      "Ondas P normales, intervalo RR variable y frecuencia <220 latidos/min en lactantes.",
      "Ausencia de ondas P e intervalo RR fijo.",
      "Inicio y terminación súbitos.",
      "Complejos QRS anchos (>0,09 s).",
  ...
  {
    "id": "semana13_pediatria_q46",
    "text": "¿Cuál es el tratamiento inicial recomendado para una taquicardia supraventricular estable con complejo QRS estrecho?",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q47",
    "text": "Todas las siguientes características corresponden a una taquicardia supraventricular, EXCEPTO:",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q48",
    "text": "En un niño con taquicardia y compromiso cardiorrespiratorio, ¿cuál es el tratamiento de elección?",
    "options": [
      "Cardioversión sincronizada.",
      "Maniobras vagales.",
      "Adenosina por vía oral.",
      "Observación clínica.",
      "Marcapasos transcutáneo."
    ],
    "correctOptionIndex": 0,
  ...
  {
    "id": "semana13_pediatria_q49",
    "text": "¿Qué medicamento se recomienda si una taquicardia supraventricular estable no responde a las maniobras vagales y se dispone de acceso intravenoso?",
    "options": [
      "Amiodarona.",
      "Adenosina.",
      "Atropina.",
  ...
  {
    "id": "semana13_pediatria_q50",
    "text": "¿Cuál es la dosis inicial recomendada de cardioversión sincronizada en un niño con taquicardia e inestabilidad hemodinámica?",
    "options": [
      "0,5–1 J/kg.",
      "2 J/kg.",
      "4 J/kg.",
  ...
  {
    "id": "semana13_pediatria_q51",
    "text": "Todas las siguientes afirmaciones sobre la adenosina son correctas, EXCEPTO:",
    "options": [
      "Tiene una vida media extremadamente corta.",
      "Debe administrarse en infusión intravenosa lenta.",
      "Debe administrarse cerca del corazón cuando sea posible.",
      "Debe acompañarse de un lavado rápido con solución salina.",
  ...
  {
    "id": "semana13_pediatria_q52",
    "text": "¿En cuál de las siguientes situaciones están indicadas las maniobras vagales?",
    "options": [
      "Taquicardia supraventricular estable sin compromiso cardiorrespiratorio.",
      "Taquicardia supraventricular con hipotensión.",
      "Taquicardia ventricular con pulso.",
      "Taquicardia con alteración del estado mental.",
  ...
  {
    "id": "semana13_pediatria_q53",
    "text": "¿Cuál es la causa más frecuente de paro cardiorrespiratorio extrahospitalario en pediatría?",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q54",
    "text": "¿Cuál es el ritmo inicial más frecuente en el paro cardiorrespiratorio pediátrico?",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q55",
    "text": "En un lactante con un solo reanimador, ¿cuál es la técnica recomendada para realizar las compresiones torácicas?",
    "options": [
      "Técnica de los dos pulgares.",
      "Compresión con una mano.",
      "Compresión con ambas manos.",
  ...
  {
    "id": "semana13_pediatria_q56",
    "text": "En un lactante con dos reanimadores, ¿qué técnica de compresión torácica proporciona la mejor calidad de RCP?",
    "options": [
      "Técnica de los dos pulgares rodeando el tórax.",
      "Técnica de los dos dedos.",
      "Compresión con una mano.",
      "Compresión alternando ambas manos.",
      "Técnica de tres dedos."
    ],
    "correctOptionIndex": 0,
  ...
  {
    "id": "semana13_pediatria_q57",
    "text": "¿Cuál de los siguientes componentes corresponde a una reanimación cardiopulmonar de alta calidad?",
    "options": [
      "Compresiones lentas con ventilaciones frecuentes.",
      "Frecuencia y profundidad adecuadas, retroceso completo del tórax e interrupciones mínimas.",
      "Compresiones superficiales con pausas prolongadas.",
      "Ventilaciones rápidas independientemente de las compresiones.",
  ...
  {
    "id": "semana13_pediatria_q58",
    "text": "¿Cuál de los siguientes ritmos es desfibrilable en el paro cardiorrespiratorio pediátrico?",
    "options": [
      "Asistolia.",
  ...
  {
    "id": "semana13_pediatria_q59",
    "text": "¿Cuál es la dosis inicial de desfibrilación recomendada en un niño con fibrilación ventricular?",
    "options": [
      "2 J/kg.",
      "4 J/kg.",
      "6 J/kg.",
  ...
  {
    "id": "semana13_pediatria_q60",
    "text": "¿Con qué frecuencia debe administrarse epinefrina durante el paro cardiorrespiratorio pediátrico?",
    "options": [
      "Cada 1–2 minutos.",
      "Cada 2–3 minutos.",
      "Cada 3–5 minutos.",
  ...
  {
    "id": "semana13_pediatria_q61",
    "text": "¿Cuál de los siguientes medicamentos está indicado en una fibrilación ventricular refractaria?",
    "options": [
      "Atropina.",
      "Adenosina.",
      "Epinefrina.",
  ...
  {
    "id": "semana13_pediatria_q62",
    "text": "¿Cuál de las siguientes corresponde a una causa reversible de paro cardiorrespiratorio pediátrico?",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q63",
    "text": "Durante la evaluación primaria, la letra \"A\" del ABCDE corresponde a:",
    "options": [
    ...
    "semana": 13,
    "tema": "Pediatría General y Emergencias",
    "subtema": "Trauma Pediátrico y Politraumatismo",
    "module": "Semana 13 - Pediatría"
  },
  {
    "id": "semana13_pediatria_q64",
    "text": "Todas las siguientes son causas de obstrucción de la vía aérea en un niño politraumatizado, EXCEPTO:",
    "options": [
      "Sangre en la vía aérea.",
      "Vómito en la vía aérea.",
      "Fractura mandibular.",
  ...
  {
    "id": "semana13_pediatria_q65",
    "text": "¿Qué maniobra está indicada para abrir la vía aérea cuando existe sospecha de lesión cervical?",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q66",
    "text": "¿Cuál de las siguientes lesiones torácicas constituye una amenaza inmediata para la vida durante la evaluación primaria?",
    "options": [
      "Neumotórax a tensión.",
      "Contusión pulmonar.",
  ...
  {
    "id": "semana13_pediatria_q67",
    "text": "¿Cuál de los siguientes hallazgos es característico del shock hemorrágico?",
    "options": [
      "Pulso amplio y piel caliente.",
      "Bradicardia con hipertensión.",
      "Ingurgitación yugular marcada.",
      "Taquicardia con llenado capilar prolongado.",
  ...
  {
    "id": "semana13_pediatria_q68",
    "text": "¿Cuál de los siguientes conjuntos de hallazgos corresponde a una pérdida moderada de sangre (30–45%)?",
    "options": [
      "Bradicardia, pulsos periféricos ausentes, hipotensión, coma y anuria.",
      "Taquicardia, pulsos normales, ansiedad, piel fría y diuresis normal.",
      "Taquicardia, pulsos periféricos disminuidos, letargo, cianosis y diuresis mínima.",
      "Bradicardia, pulsos normales, confusión, piel caliente y diuresis aumentada.",
  ...
  {
    "id": "semana13_pediatria_q69",
    "text": "¿Cuál de las siguientes afirmaciones sobre la presión de perfusión cerebral (PPC) es correcta?",
    "options": [
      "Es la suma de la presión arterial media y la presión intracraneal.",
      "Es igual a la presión intracraneal cuando aumenta la presión arterial.",
  ...
  {
    "id": "semana13_pediatria_q70",
    "text": "¿Cuál es el valor normal de la presión intracraneal (PIC) en niños?",
    "options": [
      "0–5 mmHg.",
      "5–15 mmHg.",
      "15–25 mmHg.",
  ...
  {
    "id": "semana13_pediatria_q71",
    "text": "¿Cuál es el límite superior aproximado de la autorregulación cerebral en niños?",
    "options": [
      "80 mmHg.",
      "100 mmHg.",
      "160 mmHg.",
  ...
  {
    "id": "semana13_pediatria_q72",
    "text": "Según la doctrina de Monro-Kellie, ¿cuáles son los tres componentes del contenido intracraneal?",
    "options": [
      "Parénquima, duramadre y sangre.",
      "Sangre, médula espinal y LCR.",
      "Parénquima, cráneo y LCR.",
      "Parénquima cerebral, sangre y líquido cefalorraquídeo.",
  ...
  {
    "id": "semana13_pediatria_q73",
    "text": "ema: Hipertensión intracraneal ¿Durante cuánto tiempo puede persistir el riesgo de hipertensión intracraneal después de un traumatismo craneoencefálico grave?",
    "options": [
      "6 horas.",
      "12 horas.",
      "24 horas.",
  ...
  {
    "id": "semana13_pediatria_q74",
    "text": "¿Qué puntaje en la escala de Glasgow define un traumatismo craneoencefálico grave?",
    "options": [
      "13–15 puntos.",
      "10–15 puntos.",
      "9–15 puntos.",
  ...
  {
    "id": "semana13_pediatria_q75",
    "text": "¿Cuál es el objetivo de presión intracraneal (PIC) en un niño de 6 años con traumatismo craneoencefálico grave?",
    "options": [
      "<15 mmHg.",
      "<20 mmHg.",
      "<22 mmHg.",
  ...
  {
    "id": "semana13_pediatria_q76",
    "text": "¿Cuál de las siguientes asociaciones entre edad y objetivo de presión intracraneal (PIC) es correcta?",
    "options": [
      "2–5 años: PIC <20 mmHg; 6–17 años: PIC <22 mmHg.",
      "2–5 años: PIC <22 mmHg; 6–17 años: PIC <20 mmHg.",
      "2–5 años: PIC <15 mmHg; 6–17 años: PIC <20 mmHg.",
      "2–5 años: PIC <18 mmHg; 6–17 años: PIC <20 mmHg.",
  ...
  {
    "id": "semana13_pediatria_q77",
    "text": "¿Cuál de los siguientes tipos de shock se caracteriza por disminución del gasto cardíaco debido a disfunción sistólica o diastólica del miocardio?",
    "options": [
      "Shock hipovolémico.",
      "Shock cardiogénico.",
      "Shock distributivo.",
  ...
  {
    "id": "semana13_pediatria_q78",
    "text": "¿Cuál de las siguientes enfermedades es una causa típica de shock obstructivo?",
    "options": [
      "Miocarditis.",
      "Anafilaxia.",
      "Taponamiento cardíaco.",
  ...
  {
    "id": "semana13_pediatria_q79",
    "text": "¿Cuál de los siguientes hallazgos es característico del shock distributivo?",
    "options": [
      "Pulsos débiles y piel fría.",
      "Ingurgitación yugular marcada.",
      "Cianosis con pulsos filiformes.",
      "Extremidades calientes con pulsos amplios.",
  ...
  {
    "id": "semana13_pediatria_q80",
    "text": "¿Cuál es el tratamiento inicial más apropiado del shock hipovolémico?",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q81",
    "text": "¿Cuál de las siguientes entidades produce un shock disociativo?",
    "options": [
      "Metahemoglobinemia.",
      "Neumotórax a tensión.",
      "Miocarditis aguda.",
  ...
  {
    "id": "semana13_pediatria_q82",
    "text": "¿En cuál de los siguientes tipos de shock está aumentada la contractilidad cardíaca como mecanismo compensador?",
    "options": [
      "Shock cardiogénico.",
      "Shock hipovolémico.",
      "Shock obstructivo.",
  ...
  {
    "id": "semana13_pediatria_q83",
    "text": "¿En cuál de los siguientes tipos de shock el alivio de la obstrucción constituye el tratamiento más importante?",
    "options": [
      "Shock hipovolémico.",
      "Shock cardiogénico.",
      "Shock obstructivo.",
  ...
  {
    "id": "semana13_pediatria_q84",
    "text": "¿Qué tipo de shock suele presentar disminución de la resistencia vascular periférica (poscarga)?",
    "options": [
      "Shock hipovolémico.",
      "Shock cardiogénico.",
      "Shock obstructivo.",
  ...
  {
    "id": "semana13_pediatria_q85",
    "text": "¿En cuál de los siguientes tipos de shock los inotrópicos tienen mayor importancia terapéutica?",
    "options": [
      "Shock hipovolémico.",
      "Shock cardiogénico.",
      "Shock obstructivo.",
  ...
  {
    "id": "semana13_pediatria_q86",
    "text": "¿Cuál de los siguientes tipos de shock suele presentar aumento del gasto cardíaco?",
    "options": [
      "Shock hipovolémico.",
      "Shock cardiogénico.",
      "Shock obstructivo.",
  ...
  {
    "id": "semana13_pediatria_q87",
    "text": "¿Cuál es la segunda causa más frecuente de muerte por lesiones no intencionales en niños a nivel mundial?",
    "options": [
      "Ahogamiento.",
      "Quemaduras.",
      "Intoxicaciones.",
  ...
  {
    "id": "semana13_pediatria_q88",
    "text": "¿En qué grupo etario es más alta la tasa de mortalidad por ahogamiento?",
    "options": [
      "5–13 años.",
      "14–17 años.",
      "1–4 años.",
  ...
  {
    "id": "semana13_pediatria_q89",
    "text": "¿Cuál es el principal sitio de ahogamiento en niños de 1 a 4 años?",
    "options": [
      "Bañeras.",
      "Ríos.",
      "Lagos.",
  ...
  {
    "id": "semana13_pediatria_q90",
    "text": "Respecto al sexo, ¿qué grupo presenta mayor mortalidad por ahogamiento?",
    "options": [
      "Mujeres adolescentes.",
      "Mujeres en todas las edades.",
      "Ambos sexos presentan la misma mortalidad.",
      "Solo los menores de 1 año.",
      "Varones."
    ],
    "correctOptionIndex": 4,
  ...
  {
    "id": "semana13_pediatria_q91",
    "text": "¿Cuál es el tipo de quemadura más frecuente en los niños menores de 4 años?",
    "options": [
  ...
  {
    "id": "semana13_pediatria_q92",
    "text": "¿Cuál es la principal causa de hospitalización por quemaduras en niños menores de 4 años?",
    "options": [
      "Quemaduras por llama.",
      "Quemaduras eléctricas.",
  ...
  {
    "id": "semana13_pediatria_q93",
    "text": "¿Cuál de las siguientes afirmaciones sobre las quemaduras en pediatría es correcta?",
    "options": [
      "Las quemaduras eléctricas predominan en menores de 4 años.",
      "Las quemaduras químicas son la principal causa de hospitalización.",
      "Las quemaduras por llama predominan en lactantes.",
      "Las escaldaduras son más frecuentes en adolescentes.",
  ...
  {
    "id": "semana13_pediatria_q94",
    "text": "Todas las siguientes características sugieren maltrato infantil en un niño con quemaduras, EXCEPTO:",
    "options": [
      "Quemaduras profundas localizadas en el tronco.",
      "Quemaduras en nalgas o espalda.",
      "Quemaduras por guante o calcetín.",
      "Quemaduras por salpicaduras de líquido caliente.",
  ...
  {
    "id": "semana13_pediatria_q95",
    "text": "¿En qué grupo de pacientes puede utilizarse la regla de los nueve para estimar la superficie corporal quemada?",
    "options": [
      "Lactantes menores de 1 año.",
      "Niños menores de 5 años.",
      "Todos los pacientes pediátricos.",
      "Mayores de 14 años o con peso superior a 20 kg.",
  ...
  {
    "id": "semana13_pediatria_q96",
    "text": "¿Qué porcentaje de la superficie corporal total representa la palma de la mano del propio paciente (incluidos los dedos)?",
    "options": [
      "1%.",
      "3%.",
      "5%.",
  ...
  {
    "id": "semana13_pediatria_q97",
    "text": "¿Cuál es el método más preciso para estimar la superficie corporal quemada en pediatría?",
    "options": [
      "Regla de los nueve.",
      "Regla de la palma.",
  ...
  {
    "id": "semana13_pediatria_q98",
    "text": "¿Cuál de las siguientes características corresponde a una quemadura de primer grado?",
    "options": [
      "Compromete toda la dermis.",
      "Presenta ampollas extensas.",
      "Afecta únicamente la epidermis.",
      "Requiere injerto cutáneo.",
  ...
  {
    "id": "semana13_pediatria_q99",
    "text": "¿Cuál es la característica típica de una quemadura de segundo grado superficial?",
    "options": [
      "Ampollas y dolor intenso.",
      "Piel seca e insensible.",
      "Escara negra y rígida.",
  ...
  {
    "id": "semana13_pediatria_q100",
    "text": "Todas las siguientes características corresponden a una quemadura de segundo grado profundo, EXCEPTO:",
    "options": [
      "Aspecto pálido o blanco.",
      "Menor sensibilidad al dolor.",
      "Curación en aproximadamente 14–21 días.",
      "Curación completa en 48–72 horas.",
  ...
  {
    "id": "semana13_pediatria_q101",
    "text": "¿Cuál de las siguientes características corresponde a una quemadura de tercer grado?",
    "options": [
      "Ampollas con piel rosada.",
      "Epidermis íntegra con eritema.",
      "Dolor intenso en toda la lesión.",
      "Curación espontánea en dos semanas.",
