...
const expectedWeekCounts = [121, 109, 84, 74, 95, 94, 82, 104, 139, 141, 106, 80, 101, 294, 109, 99, 303];
...
if (questions.length !== 2135) throw new Error(`Total ${questions.length}; esperado 2135`);
