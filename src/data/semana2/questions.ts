...
export const questionsSemana2: Question[] = [
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "La producción hepática de glucosa aumenta de forma temprana, aunque suele ser posterior a la resistencia en el músculo. No requiere la falla total de la célula beta para manifestarse.\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- Músculo: Principal sitio de resistencia periférica.\r\n- Hígado: Responsable de la hiperglucemia en ayuno por exceso de producción.\r\n- Obesidad: Presente en >80% de los pacientes con DM2.",
  ...
  },
  {
    ...
    "correctOptionIndex": 1,
    "explanation": "Existe un deterioro progresivo previo a la diabetes clínica, no es súbito (distractor A). Puede desarrollarse a cualquier edad (distractor C). Los autoanticuerpos suelen aparecer mucho antes de la hiperglucemia franca (distractor D).\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- Umbral: Se requiere perder el 70-80% de las células beta para la clínica.\r\n- Péptido C: Refleja la producción de insulina endógena.\r\n- Etapa 1: Presencia de dos o más autoanticuerpos con normoglucemia.",
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "En la cetoacidosis diabética hay déficit de potasio total, pero la acidosis desplaza el potasio al exterior celular elevándolo falsamente en suero inicialmente. La hiponatremia suele ser facticia por el efecto osmótico de la glucosa. La amilasa elevada suele ser salival (distractor D).\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- Potasio: Debe reponerse cuando los niveles séricos sean normales o bajos una vez iniciada la insulina.\r\n- Sodio corregido: Se añade 1.6 mEq por cada 100 mg/dL de glucosa extra.\r\n- Anion Gap: Elevado por cetoácidos.",
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "El daño microvascular se correlaciona estrictamente con la duración de la hiperglucemia (distractor A). Microaneurismas y exudados son típicos de la retinopatía NO proliferativa (distractor B). La albuminuria es un marcador clave de riesgo (progresión renal y cardiovascular).\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- Retinopatía: Principal causa de ceguera en edad laboral.\r\n- Nefropatía: Se inicia con hiperfiltración glomerular.\r\n- Neuropatía: La pérdida de sensibilidad es un signo temprano crítico para prevenir úlceras.",
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "La amplitud de los pulsos de ACTH determina el ritmo circadiano. El pico es a las 08:30 (acrofase) y el nadir a medianoche (distractor A). El feedback es negativo y suprime la POMC (distractor B). La AVP estimula la liberación de ACTH (distractor D).\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- POMC: Precursor de ACTH, MSH y endorfinas.\r\n- Estrés: La inflamación activa el eje mediante citocinas (IL-6).\r\n- Ritmo: Alterado en el Síndrome de Cushing (pérdida del nadir nocturno).",
  ...
  },
  {
    ...
    "correctOptionIndex": 1,
    "explanation": "La deficiencia de aldosterona causa pérdida de sodio y retención de potasio. La pigmentación es por exceso de ACTH/POMC (no deficiencia). En la insuficiencia primaria hay destrucción de la glándula (no permanece intacta). Los andrógenos se pierden tanto en la forma primaria como en la secundaria.\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- Etiología: La suprarrenalitis autoinmunitaria es la causa más común en países desarrollados.\r\n- Hipotensión: Ortostática que progresa a shock en crisis aguda.\r\n- Diagnóstico: Cortisol bajo con ACTH elevada.",
  ...
  },
  {
    ...
    "correctOptionIndex": 0,
    "explanation": "La ACTH suprimida indica causa suprarrenal, no hipofisaria (distractor B). El diagnóstico de Cushing debe ser bioquímico antes de pedir imágenes; el seno petroso no es el primer estudio. El cortisol a medianoche es muy sensible porque en sanos debe estar en su punto más bajo (nadir).\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- Causa más frecuente: Adenoma hipofisario (Enfermedad de Cushing).\r\n- Clínica: Obesidad central, estrías violáceas (>1 cm), debilidad proximal.\r\n- Cushing ectópico: Sugerido por hipopotasemia grave e hiperpigmentación de inicio rápido.",
    "pagina": "Harrison. Cap. 379. Trastornos de la corteza suprarrenal. Pág: 2720.",
    "materia": "Medicina Interna",
    "semana": 2,
    "tema": "MÓDULO 4: PATOLOGÍA SUPRARRENAL",
  ...
  },
  {
    ...
    "correctOptionIndex": 1,
    "explanation": "La deficiencia de 21-hidroxilasa desvía la síntesis hacia andrógenos, causando virilización. La supresión total de 17-OHP indicaría sobretratamiento (distractor A). En estrés la dosis debe aumentarse (no suspenderse). La pérdida de sal ocurre en la forma \"clásica perdedora de sal\" (distractor D).\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- Marcador: 17-hidroxiprogesterona (17-OHP).\r\n- Genética: Autosómica recesiva (gen CYP21A2).\r\n- Forma no clásica: Puede simular síndrome de ovarios poliquísticos en mujeres jóvenes.",
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "Las masas ricas en lípidos (típicas de adenomas benignos) tienen baja densidad en TC (<10 HU). El tamaño es sensible pero poco específico (distractor A). La mayoría son inactivos (distractor B). El muestreo venoso solo se indica en casos específicos de aldosteronismo confirmado.\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- Evaluación: Siempre excluir feocromocitoma y Cushing subclínico.\r\n- Densidad >20 HU: Aumenta la sospecha de malignidad o feocromocitoma.\r\n- Umbral quirúrgico: Masa >4 cm suele sugerir necesidad de resección.",
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "El punto de ajuste lo establece la TSH en respuesta a T4/T3. Dopamina y glucocorticoides suprimen la TSH solo en dosis farmacológicas. Las hormonas tiroideas son las que inhiben directamente la subunidad B de la TSH.\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- TSH: Hormona glucoproteínica con subunidad alfa común (LH, FSH, hCG).\r\n- T3: Principal mediador de la retroalimentación negativa sobre TRH y TSH.\r\n- Semivida: T4 (7 días), T3 (1 día), TSH (prolongada en comparación con otras peptídicas).",
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "La fase inicial es tirotóxica por liberación de hormona preformada. La captación es baja (<5%) porque el tejido está dañado y la TSH suprimida. El tratamiento son AINES o glucocorticoides; los antitiroideos no son útiles ya que no hay exceso de síntesis.\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- Histología: Células gigantes multinucleadas y granulomas.\r\n- Evolución: Tres fases (Tirotóxica -> Hipotiroidea -> Recuperación).\r\n- Hipotiroidismo permanente: Ocurre solo en el 15% de los casos.",
  ...
  },
  {
    ...
    "correctOptionIndex": 0,
    "explanation": "Hierro y calcio bloquean la absorción gástrica. Los estrógenos aumentan la TBG, lo que suele requerir un aumento de la dosis de T4. El objetivo es normalizar la TSH, no suprimirla (excepto en cáncer de tiroides).\r\n\r\n💡 PUNTOS CLAVE (REPASO ACTIVO):\r\n\r\n- Semivida: T4 dura 7 días; se requiere 1 mes para alcanzar el estado estable.\r\n- Toma: Ayuno, al menos 30-60 min antes del desayuno.\r\n- Interacciones: Rifampicina y fenitoína aumentan el metabolismo de T4.",
  ...
  },
  {
    ...
    "correctOptionIndex": 1,
    "explanation": "El receptor de la TSH activa la subunidad Gsa, aumentando el AMPc. McCune-Albright se debe a mutaciones activadoras que INCREMENTAN el AMPc (distractor A). La inactivación de Gsa causa resistencia a hormonas como la PTH (pseudohipoparatiroidismo), no simula sus acciones (distractor C). El receptor de ACTH es un GPCR, no un receptor nuclear (distractor D).",
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "El receptor de GH puede desprender su dominio extracelular para formar la GHBP. El IGF-I ejerce retroalimentación negativa, no positiva. La GH es lipolítica (reduce grasa), no lipogénica. La somatostatina es el principal inhibidor de la liberación de GH.",
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "La neurohipófisis normal brilla en T1 debido a fosfolípidos relacionados con el almacenamiento de AVP; su ausencia es típica de la diabetes insípida central. En la forma nefrógena, la AVP está elevada debido a la resistencia periférica. La polidipsia primaria cursa con osmolalidad urinaria diluida (baja).",
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "Los mecanismos de retroalimentación ajustan la secreción para mantener estable la fracción libre a pesar de cambios en los transportadores. La SHBG disminuye en obesidad y resistencia a la insulina. Las hormonas esteroideas no se almacenan, se secretan inmediatamente tras su síntesis.",
  ...
  },
  {
    ...
    "correctOptionIndex": 2,
    "explanation": "Los receptores de tipo I (como el de glucocorticoides o estrógenos) forman homodímeros y reconocen secuencias palindrómicas. Los que forman heterodímeros con RXR son los de tipo II. Los receptores tipo I se encuentran en el citoplasma o núcleo, a menudo unidos a proteínas de choque térmico.",
    "pagina": "Harrison. Cap. 370. Mecanismos de acción hormonal. Pág: 2657.",
    "materia": "Medicina Interna",
    "semana": 2,
    "tema": "MÓDULO 1: FISIOLOGÍA ENDOCRINA E HIPOFISARIA",
